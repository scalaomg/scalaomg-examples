...
import moneygrabber.client.view.game.GameFrame.GameFrameClosed
import moneygrabber.client.view.game.GameGrid.ButtonPressedEvent
import moneygrabber.client.view.game.GameView.{GameEnd, GameStarted}
import moneygrabber.client.view.game.{GameFrame, GameView}
import moneygrabber.common.Board
import moneygrabber.common.Entities.{Direction, Down, Left, Right, Up}
...
case class GameViewController(private val frame: GameFrame, private val room: JoinedRoom) extends Publisher {
  ...
  private def onGameEnd(gameState: Board): Unit = {
    import moneygrabber.client.view.utils.Utils._
    SwingUtilities.invokeLater(() => {
