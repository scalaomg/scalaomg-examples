package roll_the_dice.client.view.scenes

import java.awt.{BorderLayout, Color, Font}

import roll_the_dice.client.view.{Utils, View, WindowSize}
import roll_the_dice.common.{A1, A2, B1, B2, MatchState, Team, Turn}
import javax.swing.{BorderFactory, Box, JButton, JLabel, JOptionPane}
import roll_the_dice.client.view.Utils.DimensionConverters._
